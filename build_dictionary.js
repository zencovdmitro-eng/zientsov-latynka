...
const meta=db.prepare('INSERT INTO metadata(key,value) VALUES(?,?)');for(const [key,value] of Object.entries({project:'ZIENTSOV LATYNKA',version:'0.4.9',release_id:'ZL-UA-2026-0003',unique_entries:String(words.length),author_legal:'Зєнцов Дмитро Володимирович',author_passport:'Dmytro Zientsov',license:'GPL-3.0'}))meta.run(key,value);db.close();console.log(`Створено ${words.length} словникових записів.`);
